...
class MSPCN(nn.Module):
    ...
    def forward(self, xyz):
        q, coarse_point_cloud, denoise_length, low_res_supervised = self.base_model(xyz) # B M C and B M 3
        B, M ,C = q.shape
        ...
        if self.training:
            ...
            ret = (pred_coarse, denoised_coarse, denoised_fine, pred_fine, low_res_supervised)
            return ret
        else:
